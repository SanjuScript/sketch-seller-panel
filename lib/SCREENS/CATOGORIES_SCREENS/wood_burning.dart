...
class WoodBurningScreen extends StatefulWidget {
  const WoodBurningScreen({super.key});

  @override
  State<WoodBurningScreen> createState() => _WoodBurningScreenState();
}
...
class _WoodBurningScreenState extends State<WoodBurningScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const HelperText1(text: 'Wood Burning Styles'),
          centerTitle: false,
        ),
