...
class BloodArtScreen extends StatefulWidget {
  const BloodArtScreen({super.key});

  @override
  _BloodArtScreenState createState() => _BloodArtScreenState();
}
...
class _BloodArtScreenState extends State<BloodArtScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const HelperText1(text: 'Blood Art Styles'),
          centerTitle: false,
        ),
