...
class BlueArtScreen extends StatefulWidget {
  const BlueArtScreen({super.key});

  @override
  State<BlueArtScreen> createState() => _BlueArtScreenState();
}
...
class _BlueArtScreenState extends State<BlueArtScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const HelperText1(text: 'Blue Art Styles'),
          centerTitle: false,
        ),
