...
class PencilArtScreen extends StatefulWidget {
  const PencilArtScreen({super.key});

  @override
  State<PencilArtScreen> createState() => _PencilArtScreenState();
}

class _PencilArtScreenState extends State<PencilArtScreen> {
  final String categoryName = "Sketch";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const HelperText1(text: 'Pencil Art Styles'),
          centerTitle: false,
        ),
